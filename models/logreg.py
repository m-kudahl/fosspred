...
# Initialize Logistic Regression model and StratifiedKFold cross-validation
...
for train_index, test_index in kf.split(X_features, y_target):
    ...
    report = classification_report(y_test, y_pred, output_dict=True, zero_division=0) # Use zero_division to suppress warnings
...
result_data = {
    'program_name': 'logistic_regression',
