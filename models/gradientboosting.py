...
# Initialize the Gradient Boosting model and StratifiedKFold cross-validation
...
# Calculate average feature importance for Gradient Boosting
...
result_data = {
    'program_name': 'gradient_boosting',
